...
<div class="container">
    ...
    <div id="cont" class="row">
        <section class="col-sm-4 offset-sm-4">
            <form action="<%= request.getContextPath()%>/dormitory?type=update&pageNow=${requestScope.pageNow}"
                  method="post">
                <%
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="buildingId">
                        ...
                        <option selected value="<%= buildingDO.getId()%>"><%= buildingDO.getUniqueNo() %>
                        </option>
                        <%
                        } else {
                        %>
                        <option value="<%= buildingDO.getId()%>"><%= buildingDO.getUniqueNo() %>
                        </option>
                        <%
                                }
                            }
