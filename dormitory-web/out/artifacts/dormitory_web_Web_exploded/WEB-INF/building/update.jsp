...
<div class="container">
  ...
  <div id="cont" class="row">
    <section class="col-sm-4 offset-sm-4">
      <form action="<%= request.getContextPath()%>/building?type=update&pageNow=${requestScope.pageNow}" method="post">
        <%
        ...
        <div class="form-group">
          ...
          <div class="form-check form-check-inline">
            ...
            %>
            <input class="form-check-input" checked type="radio" name="buildingType" id="maleRadio" value="M">
            <%
            } else {
            %>
          ...
          <div class="form-check form-check-inline">
            ...
            %>
              <input class="form-check-input" checked type="radio" name="buildingType" id="femaleRadio" value="F">
            <%
            } else {
            %>
