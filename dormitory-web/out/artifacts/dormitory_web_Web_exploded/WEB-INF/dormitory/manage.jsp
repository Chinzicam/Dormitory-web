    ...
    <div class="row">
      <section class="search col-sm-12 mb-2">
        ...
        <div class="d-flex justify-content-start align-items-center">
          ...
          <form method="post" class="form-inline mb-0" action="<%=request.getContextPath()%>/dormitory?type=toManage">
            <input  class="form-control" type="text" name="no" placeholder="按宿舍编号模糊搜索" value="<%= tableResult.getSearchWord()%>"/>
